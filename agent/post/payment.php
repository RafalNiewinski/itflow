...
if (isset($_POST['add_bulk_payment'])) {
    ...
    if ($email_receipt == 1) {
        ...
        $sql_company = mysqli_query($mysqli,"SELECT company_phone, company_phone_country_code FROM companies WHERE company_id = 1");
