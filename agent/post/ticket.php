...
if (isset($_POST['edit_ticket_contact'])) {
    ...
    if ($notify && filter_var($contact_email, FILTER_VALIDATE_EMAIL) && !empty($config_smtp_provider)) {
...
if (isset($_POST['bulk_ticket_reply'])) {
    ...
    if (isset($_POST['ticket_ids'])) {
        ...
        foreach ($_POST['ticket_ids'] as $ticket_id) {
            ...
            if ($original_ticket_status == 4 && $ticket_status != 4 && $ticket_status != 5) {
